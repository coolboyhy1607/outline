...
//   Guest.hasMany(models.ApiKey, { as: "apiKeys", onDelete: "cascade" });
//   Guest.hasMany(models.NotificationSetting, {
//     as: "notificationSettings",
//     onDelete: "cascade",
//   });
//   Guest.hasMany(models.Document, { as: "documents" });
//   Guest.hasMany(models.View, { as: "views" });
//   Guest.hasMany(models.UserAuthentication, { as: "authentications" });
//   Guest.belongsTo(models.Team);

//   Guest.addScope("withAuthentications", {
//     include: [{ model: models.UserAuthentication, as: "authentications" }],
//   });
// };

// Instance methods
// Guest.prototype.collectionIds = async function (options = {}) {
...
// Guest.prototype.updateActiveAt = function (ip, force = false) {
...
// Guest.prototype.updateSignedIn = function (ip) {
...
// Guest.prototype.getJwtToken = function (expiresAt?: Date) {
//   return JWT.sign(
//     {
//       id: this.id,
...
// Guest.prototype.getTransferToken = function () {
//   return JWT.sign(
//     {
//       id: this.id,
...
// Guest.prototype.getEmailSigninToken = function () {
//   return JWT.sign(
...
// Guest.beforeDestroy(removeIdentifyingInfo);
// Guest.beforeSave(uploadAvatar);
// Guest.beforeCreate(setRandomJwtSecret);

// // By default when a user signs up we subscribe them to email notifications
// // when documents they created are edited by other team members and onboarding
// Guest.afterCreate(async (user, options) => {
//   await Promise.all([
...
// Guest.getCounts = async function (teamId: string) {
//   const countSql = `
//     SELECT
...
// Guest.prototype.demote = async function (
//   teamId: string,
//   to: "member" | "viewer"
// ) {
//   const res = await Guest.findAndCountAll({
//     where: {
//       teamId,
//       isAdmin: true,
//       id: {
...
// Guest.prototype.promote = async function () {
//   return this.update({ isAdmin: true, isViewer: false });
// };

// Guest.prototype.activate = async function () {
//   return this.update({
//     suspendedById: null,
//     suspendedAt: null,
//   });
